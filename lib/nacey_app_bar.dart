...
class MaterialAppBarData extends _AppBarData {
  MaterialAppBarData({
    Widget? title,
    Color? backgroundColor,
    Widget? leading,
...
class CupertinoAppBarData extends _AppBarData {
  CupertinoAppBarData({
    Widget? title,
    Color? backgroundColor,
    Widget? leading,
...
class FluentNavigationBarData extends _AppBarData {
...
class NaceyAppBar extends NaceyWidgetBase<mat.PreferredSizeWidget,
    CupertinoAppBar, FluentAppBar> {
  final Widget? title;
  final Color? backgroundColor;
  final Widget? leading;
  ...
  FluentAppBar createFluentWidget(BuildContext context) {
    // TODO: implement createFluentWidget
...
class MaterialAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  static double preferredHeightFor(BuildContext context, Size preferredSize) {
    if (preferredSize is _PreferredAppBarSize &&
      ...
      return ((mat.AppBarTheme.of(context).toolbarHeight ?? matToolbarHeight) +
  ...
  bool _getEffectiveCenterTitle(mat.ThemeData theme) {
...
class _PersistentNavigationBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (leading == null && backChevron != null && backLabel != null) {
      leading = IconButton(
        icon: const mat.Icon(CupertinoIcons.chevron_back),
